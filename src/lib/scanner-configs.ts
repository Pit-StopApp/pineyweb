...
export const SCANNER_CONFIGS: Record<string, ScannerConfig> = {
  ...
  "sip-society": {
    ...
    keywords: [
      // High-yield terms first (scanner uses first 3)
      "wedding venue", "event venue", "wedding planner",
      "banquet hall", "event space", "event center",
      "reception venue", "country club", "catering company",
      "wedding coordinator", "event coordinator", "event planner",
      "bridal consultant", "party planner",
      "golf club event space", "winery event venue", "vineyard wedding",
      "barn wedding venue", "ranch wedding venue", "estate wedding venue",
      "bridal shop", "wedding florist", "wedding photographer",
      "wedding DJ", "party rental company",
    ],
